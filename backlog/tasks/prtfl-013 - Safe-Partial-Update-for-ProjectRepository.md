...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Add GetProjectByID query to projects.sql and regenerate db code
- [ ] #2 Refactor projectRepository.UpdateProject to fetch-and-merge existing data with update input
- [ ] #3 Implement nil checks for all fields in ProjectUpdateInput to prevent runtime panics during partial updates
