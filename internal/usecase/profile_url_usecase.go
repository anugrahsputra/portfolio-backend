...
type ProfileUrlUsecase interface {
	...
	GetProfileUrl(ctx context.Context, profileID string) ([]domain.ProfileUrl, error)
	GetProfileUrlByID(ctx context.Context, id string) (domain.ProfileUrl, error)
...
func (u *profileUrlUsecase) GetProfileUrl(ctx context.Context, profileID string) ([]domain.ProfileUrl, error) {
	result, err := u.repo.GetProfileUrl(ctx, profileID)
	if err != nil {
		return nil, err
	}
...
func (u *profileUrlUsecase) GetProfileUrlByID(ctx context.Context, id string) (domain.ProfileUrl, error) {
	result, err := u.repo.GetProfileUrlByID(ctx, id)
	if err != nil {
